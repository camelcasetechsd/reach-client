/*
 * ScrollTo
 * - add custom button to scroll to top of page or a div.
 */
...
const ScrollUp = React.createClass({
 ...
 * Example usage
 */
const ScrollUpDemo = React.createClass({
  render: function() {
		return (
	  	<div>
...
render(<ScrollUpDemo />, document.getElementById('scrollTo'));